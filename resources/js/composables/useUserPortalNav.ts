...
export function useUserPortalNav(): {
    mainNavItems: ComputedRef<NavItem[]>;
    ...
    const isStaffUser = computed(() => page.props.staffUser?.is_active === true);
    const isProviderMember = computed(() => page.props.serviceProviderMembership != null);
