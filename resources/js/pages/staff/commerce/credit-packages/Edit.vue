...
import { index, update } from '@/routes/staff/commerce/credit-packages';
...
<template>
    <StaffLayout>
        ...
        <StaffPageHeader title="Edit credit package" />
        <Card>
            <CardHeader><CardTitle>Details</CardTitle></CardHeader>
            <CardContent>
                <Form v-bind="update.form(props.package.id)" class="space-y-6" #default="{ errors, processing }">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Textarea id="description" name="description" rows="4" :default-value="package.description" />
                        <InputError :message="errors.description" />
                    </div>
                    <div class="grid gap-2">
                        <Label for="page_count">Page count</Label>
                        <Input id="page_count" name="page_count" type="number" min="1" :default-value="package.page_count" required />
