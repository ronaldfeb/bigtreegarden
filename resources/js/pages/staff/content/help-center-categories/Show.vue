...
import { index, edit, destroy, show } from '@/routes/staff/content/help-center-categories';
...
<template>
    <StaffLayout>
        ...
        <StaffPageHeader
            :title="String(props.category.title ?? props.category.name ?? props.category.client_name ?? 'Help category')"
