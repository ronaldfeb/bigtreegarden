...
import { index, show, store, update } from '@/routes/staff/content/partners';
...
<template>
    <StaffLayout>
        ...
        <StaffPageHeader title="Create partner" />
    ...
    <Input id="logo_path" name="logo_path" type="text"  required />
