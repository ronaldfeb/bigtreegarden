...
import { index, show, store, update } from '@/routes/staff/content/pamphlet-background-collections';

</script>

<template>
    <StaffLayout>
        <Head title="Create pamphlet collection" />

        <StaffPageHeader title="Create pamphlet collection" />
